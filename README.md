# OpenSlot v0.2 foundation

OpenSlot matches local providers' unused appointment inventory with customers. This repository preserves the polished React 19, TypeScript, Vite, hash-router, and CSS prototype while introducing a Supabase-backed multi-user foundation.
